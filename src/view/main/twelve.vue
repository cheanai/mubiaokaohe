    ...
    <div class="body_div">
        <div>
            <el-breadcrumb separator-class="el-icon-arrow-right">
                ...
                <el-breadcrumb-item>聘请外教外文授课</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
...
import DialogForm from "@/view/dialog/dialogeleven.vue";
...
if(store.department=='人事处管理员'){
    store.routerPath = '/index1/twelve1'
}else{
store.routerPath='/index/twelve'}
...
const searchdata = () => {
    ...
    if (value.value == "") {
        console.log("--------")
        axios.get("/selectForeignTeacherByName", {
            params: {
                name: input.value,
        ...
        axios.get("/selectForeignTeacherByNameAndState", {
            params: {
                state: value.value,
                name: input.value,
                department: store.department
...
const edit = (id: number) => {
    console.log(id);
    axios.get("/selectForeignTeacherById", {
        params: {
            id: id
        }
    }).then((response) => {
...
const tongguo = (id: number) => {
    console.log(id);
    axios.get("/updateForeignTeacherById", {
        params: {
            id: id,
            state:'已通过'
        }
...
const dataFilter = () => {
    ...
    if (input.value == "") {
        ...
        axios.get("/selectForeignTeacherByState", {
            params: {
                state: value.value,
                department: store.department
            }
