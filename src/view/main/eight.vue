    ...
    <div class="body_div">
        <div>
            <el-breadcrumb separator-class="el-icon-arrow-right">
                ...
                <el-breadcrumb-item>新增教授</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
...
import DialogForm from "@/view/dialog/dialogseven.vue";
...
if(store.department=='人事处管理员'){
    store.routerPath = '/index1/eight1'
}else{
store.routerPath = '/index/eight'
}
...
const searchdata = () => {
    ...
    if (value.value == "") {
        console.log("--------")
        axios.get("/selectProfessorByName", {
            params: {
                name: input.value,
        ...
        axios.get("/selectProfessorByNameAndState", {
            params: {
                state: value.value,
                name: input.value,
                department: store.department
...
const dataFilter = () => {
    ...
    if (input.value == "") {
        ...
        loading.value = !loading.value;
        axios.get("/selectProfessorByState", {
            params: {
                state: value.value,
                department: store.department
            }
